      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-cyan-400 font-semibold text-2xl sm:text-3xl">
              It's in the detail.
            </span>
          </motion.p>
          ...
          >
            {[
              { icon: Calendar, text: 'By Appointment Only' },
              { icon: MapPin, text: 'South of Johannesburg' },
              { icon: Award, text: 'Professional Results' },
            ].map((item, index) => (
              <motion.div
                key={index}
